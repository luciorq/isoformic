# Contributing to Isoformic

This outlines how to propose a change to Isoformic. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("luciorq/isoformic", fork = TRUE)`.
...
Please note that the Isoformic project is released with a [Contributor
Code of Conduct](https://luciorq.github.io/isoformic/CODE_OF_CONDUCT.md)
