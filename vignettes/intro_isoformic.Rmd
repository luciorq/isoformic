...
The [GENCODE][gencode-ref] project offers a good annotation of isoforms for the human and mouse genomes, including isoforms of non-coding genes.
...
# download_reference(version = "33", file_type = "gff")
...
`tximeta` is capable of importing most of the annotation automatically,
but for getting the transcript types we will will need to create the `linkedTxome` object manually.
...
### Part 3: Transcript to Gene and Gene to transcript
...
```{r, warning = FALSE, message = FALSE}
fasta_path <- "data-raw/gencode.v33.transcripts.fa.gz"
